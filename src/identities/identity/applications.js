...
const ORBITDB_APP_STORE_NAME = 'applications';
const ORBITDB_APP_DEVICES_STORE_NAME = 'applications!devices';
...
class Applications {
    ...
    constructor(currentDeviceId, identityDescriptor, appsStore, appsDevicesStore) {
        ...
        // this.#orbitdbStore.events.on('write', this.#handleStoreChanges);
        // this.#orbitdbStore.events.on('replicated', this.#handleStoreChanges);
    }
    ...
    async unlinkCurrentDevice(appId) {
        ...
        // Currently we are only deleting from appDevicesStore and keeping the app in the appsStore
        // Maybe in the future we should find a way of safely removing an unused app when revoking for a current device
